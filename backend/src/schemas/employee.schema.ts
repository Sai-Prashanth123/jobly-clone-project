...
export const createEmployeeSchema = z.object({
  ...
  eVerifyStatus: z.enum(['not_started','pending','employment_authorized','tentative_nonconfirmation','case_closed']).optional().nullable(),
  eVerifyCaseNumber: z.string().optional().nullable(),
