...
import performanceReviewRoutes from './performanceReviews.routes';
import enrollmentFormRoutes from './enrollmentForms.routes';
...
router.use('/enrollment-forms', enrollmentFormRoutes);
