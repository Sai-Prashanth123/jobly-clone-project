...
export async function logActivity(
  ...
  entityType: 'employee' | 'client' | 'assignment' | 'timesheet' | 'monthly_timesheet' | 'invoice' | 'portal_user' | 'payment' | 'leave_request' | 'announcement' | 'leave_type' | 'leave_entitlement' | 'expense_report' | 'onboarding_template' | 'onboarding_task' | 'asset' | 'performance_review' | 'holiday' | 'system_setting' | 'offboarding_template' | 'offboarding_task' | 'skill' | 'shift' | 'budget' | 'tax_document' | 'enrollment_form' | 'case' | 'case_filing' | 'case_note' | 'case_document' | 'petitioner' | 'support_ticket',
  entityId: string,
  entityLabel: string,
  metadata?: object,
) {
