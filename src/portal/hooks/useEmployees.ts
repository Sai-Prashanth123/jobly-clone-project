...
export function mapEmployee(raw: any): Employee {
  return {
    ...
    eVerifyStatus: raw.e_verify_status ?? undefined,
    eVerifyCaseNumber: raw.e_verify_case_number ?? undefined,
...
function toSnake(e: Partial<Employee>): Record<string, any> {
  ...
  return {
    ...
    ...(e.eVerifyStatus !== undefined && { eVerifyStatus: e.eVerifyStatus }),
    ...(e.eVerifyCaseNumber !== undefined && { eVerifyCaseNumber: blank(e.eVerifyCaseNumber) }),
